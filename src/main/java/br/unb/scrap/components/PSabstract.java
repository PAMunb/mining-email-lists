...
/**
 * Classe abstrata que define um esqueleto para realizar a raspagem de dados de uma página web.
 */
...
public abstract class PSabstract extends ConnectionJsoup {
    ...
    /**
     * Método abstrato que percorre uma lista de URLs, faz a raspagem de dados dessas URLs
    ...
    /**
     * Método responsável por obter os links dos posts por data a partir de um documento
     * HTML, a partir da BASE_URL ou da URL passada.
     *
    ...
    /**
     * Método que extrai o autor e a data do post a partir do documento HTML fornecido.
     *
     * @param doc  O documento HTML
     * @param post O objeto Post a ser preenchido com as informações de autor e data.
     */
    ...
    /**
     * Método que extrai o conteúdo do corpo do post a partir do documento HTML fornecido.
     *
     * @param doc  O documento HTML
    ...
    /**
     * Método que verifica se a palavra-chave ("Reply") está presente no
     * conteúdo HTML de um documento.
     *
     * @param doc  O documento HTML
