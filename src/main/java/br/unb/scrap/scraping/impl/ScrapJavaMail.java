...
/**
 * Classe responsável por realizar a raspagem de dados do site JavaMail.
 */
@Component
@Data
...
public class ScrapJavaMail implements PageScraper {
	...
	public ScrapJavaMail() throws IOException {
		this.fileLogger = new FileLogger("scrap_log_JavaMail.txt");
	}
	/**
